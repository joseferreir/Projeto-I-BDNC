 ...
 */
package br.edu.ifpb.falai.exceptions;
    ...
    public void handle() throws FacesException {
        ...
        while (iterator.hasNext()) {
            ...
            try {
                ...
                FacesMessage msg = new FacesMessage("Email ou senha já cadastrados");
...
//                exception.printStackTrace();
                ...
                erro403 = "pageError/403?faces-redirect=true";
                erro404 = "pageError/404?faces-redirect=true";
                erro500 = "pageError/500?faces-redirect=true";
                ismailsenha = "cadastro_pessoa?faces-redirect=true";
               if(exception != null && exception.getCause()!=null){
                Throwable erro = exception.getCause();
                String c = erro.toString();
                if(c.contains("java.lang.IndexOutOfBoundsException: Index: 0"))
                    pageErro = erro403;
                else
              ...
              if(c.contains("usuario_email_key")){
             //  FacesContext.getCurrentInstance().addMessage("erro",msgemail);
                 msg.setSummary("E mail ou senha já cadastrado");
             pageErro = ismailsenha;
              }
             //pageErro =null;
              else if(c.contains("usuario_senha_key")){
                  msg.setSummary("senha já cadastrada");
                   pageErro = ismailsenha;
              }
               }
               else
